<li class="side-menus {{ Request::is('*') ? 'active' : '' }}">
     ...
     <a class="nav-link" href="/roles">
        <i class=" fas fa-user-lock" style='font-size:25px'></i><span>Roles</span>
     </a>

     <a class="nav-link" href="/cursos">
        <i class=" fas fa-book" style='font-size:25px' ></i><span>Cursos</span>
     </a>

     <a class="nav-link" href="/actividades">
        <i class="fas fa-chalkboard-teacher" style='font-size:25px'></i><span>Actividades</span>
     </a>
